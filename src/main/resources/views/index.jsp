...
<head>
		...
		<link href="views/css/amazeui.css" rel="stylesheet" type="text/css" />
		<link href="views/css/admin.css" rel="stylesheet" type="text/css" />

		<link href="views/css/demo.css" rel="stylesheet" type="text/css" />

		<link href="views/css/hmstyle.css" rel="stylesheet" type="text/css"/>
		<link href="views/css/skin.css" rel="stylesheet" type="text/css" />
...
<body>
		...
		<script>
			window.jQuery || document.write('<script src="views/js/jquery.min.js "><\/script>');
		</script>
		<script type="text/javascript " src="views/js/quick_links.js "></script>
	</body>
</html>