...
<!--       	<s:iterator value="goodsClass" var="goodsClass">
 ...
 -->
  ...
  <tr>
	...
	<tr>
		<td class=forumrow height=24><div align="right">起拍时间：</div></td>
		<td class=forumrowhighlight height=24>
	...
	<tr>
		<td class=forumrow height=24><div align="right">截止时间：</div></td>
		<td class=forumrowhighlight height=24>
			<input id="end_time" name="end_time" class="laydate-icon" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss',elem: '#end_time'})"/>
		</td>
	</tr>
  ...
  <td><input type="hidden" name="owner_name" value="<s:property value="#session.user.nick_name"/>"/></td>
  <tr>
