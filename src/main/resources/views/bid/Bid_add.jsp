...
<form action="Bid_add.action" method="post">
<table align="center">
	<input type="hidden" id="goods_id" name="goods_id" value="<s:property value="#session.goods.goods_id"/>"/>
	<tr>
		<td>商品名称：</td>
	...
	<tr>
		<td>成交价格：</td>
		<td><input type="text" id="price" name="price" value="<s:property value="#session.goods.max_price"/>"/></td>
	</tr>
	<tr>
		<td>收货地址：</td>
		<td><input type="text" id="address" name="address"  value="<s:property value="#session.user.address"/>" /></td>
	</tr>
	<tr>
		<td>卖家姓名：</td>
		<td><input type="text" id="owner_name" name="owner_name"  value="<s:property value="#session.goods.owner_name"/>" /></td>
	</tr>
	<tr>
		<td>卖家联系方式：</td>
